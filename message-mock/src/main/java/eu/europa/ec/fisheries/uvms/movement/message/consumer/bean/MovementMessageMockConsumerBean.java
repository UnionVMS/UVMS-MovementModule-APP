...
@Stateless
public class MovementMessageMockConsumerBean extends AbstractConsumer implements MessageConsumer, ConfigMessageConsumer {

    final static Logger LOG = LoggerFactory.getLogger(MovementMessageMockConsumerBean.class);
