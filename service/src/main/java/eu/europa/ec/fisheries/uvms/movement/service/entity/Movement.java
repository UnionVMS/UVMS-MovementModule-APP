...
@NamedQueries({
    ...
    @NamedQuery(name = Movement.FIND_BY_GUID_LIST, query = "SELECT m FROM Movement m WHERE m.guid IN :guidList AND m.duplicate = false"),
...
public class Movement implements Serializable, Comparable<Movement> {
    ...
    public static final String FIND_BY_GUID_LIST = "Movement.findByGUIDList";
