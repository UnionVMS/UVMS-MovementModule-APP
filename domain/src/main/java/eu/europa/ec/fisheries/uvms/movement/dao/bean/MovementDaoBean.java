...
public class MovementDaoBean extends Dao implements MovementDao {
    ...
    public Movement getMovementsByGUID(final String guid) throws MovementDaoException {
        try {
            final TypedQuery<Movement> query = em.createNamedQuery("Movement.findByGUID", Movement.class);
            query.setParameter("guid", guid);
            final Movement singleResult = query.getSingleResult();
            return singleResult;
    ...
    @Override
	public Movement getMovementById(final Long id) {
        return em.find(Movement.class, id);
    }

    public List<Movement> getLatestMovementsByConnectIdList(final List<String> connectIds) throws MovementDaoException {
        try {
            final List<Movement> resultList = new ArrayList<>();
            final TypedQuery<LatestMovement> latestMovementQuery = em.createNamedQuery("LatestMovement.findLatestByMovementConnectList", LatestMovement.class);
            latestMovementQuery.setParameter("connectId", connectIds);
            for (final LatestMovement lm : latestMovementQuery.getResultList()) {
    ...
    public List<Movement> getLatestMovementsByConnectId(final String connectId, final Integer amount) throws MovementDaoException {
        try {
            if (amount == 1) {
                final List<Movement> resultList = new ArrayList<>();
            ...
            final TypedQuery<Movement> query = em.createNamedQuery("Movement.findLatestByMovementConnect", Movement.class);
            query.setParameter("connectId", connectId);
            query.setMaxResults(amount);
            final List<Movement> resultList = query.getResultList();
            return resultList;
        } catch (final javax.persistence.NoResultException e) {
            LOG.debug("No result when retrieveing movements by GUID");
            return null;
    ...
    public AreaType getAreaTypeByCode(final String code) throws MovementDaoException {
        try {
            final long start = System.currentTimeMillis();
            final TypedQuery<AreaType> query = em.createNamedQuery("AreaType.findByCode", AreaType.class);
            query.setParameter("code", code);
            final AreaType singleResult = query.getSingleResult();
            ...
            return null;
        } catch (final javax.persistence.NonUniqueResultException e) {
            LOG.error("Duplicate area type in DB for code: {}. Cleaning up duplicates.", code);
            final TypedQuery<AreaType> query = em.createNamedQuery("AreaType.findByCode", AreaType.class);
            query.setParameter("code", code);
            final List<AreaType> areaList = query.getResultList();
     ...
     */
    public Area getAreaByRemoteIdAndCode(final String code, final String remoteId) throws MovementDaoException {
        try {
            final long start = System.currentTimeMillis();
            ...
            final Area singleResult = query.getSingleResult();
            final long diff = System.currentTimeMillis() - start;
    ...
    public List<Movement> isDateAlreadyInserted(final String id, final Date date) {
        try {
            final long start = System.currentTimeMillis();
            ...
            final TypedQuery<Movement> query = em.createNamedQuery("Movement.findExistingDate", Movement.class);
    ...
    @Override
    public List<LatestMovement> getLatestMovements(final Integer numberOfMovements) throws MovementDaoException {
        try {
            final TypedQuery<LatestMovement> latestMovementQuery = em.createNamedQuery("LatestMovement.findLatest", LatestMovement.class);
            latestMovementQuery.setMaxResults(numberOfMovements);
            final List<LatestMovement> rs = latestMovementQuery.getResultList();
            return rs;
        } catch (final javax.persistence.NoResultException e) {
    ...
    @Override
    public Movement getLatestMovement(final String id, final Date date, final boolean tryLatestTable) throws MovementDaoException {

            try {
                Movement singleResult;
                if (tryLatestTable) {
                    try {
                        final LatestMovement latest = getLatestMovement(id);
                        singleResult = latest.getMovement();
                    } catch (final javax.persistence.NoResultException e) {
                        final TypedQuery<Movement> query = em.createNamedQuery("Movement.findLatest", Movement.class);
                        query.setParameter("id", id);
    ...
    @Override
	public Movement getLatestMovementByTimeStamp(final String id, final Date date){
    ...
    @Override
	public void upsertLatestMovement(final Movement movement, final MovementConnect movementConnect) throws MovementDaoException {
    ...
    private LatestMovement getLatestMovement(final String connectId) throws javax.persistence.NoResultException {
        final TypedQuery<LatestMovement> latestMovementQuery = em.createNamedQuery("LatestMovement.findLatestByMovementConnect", LatestMovement.class);
        latestMovementQuery.setParameter("connectId", connectId);
        return latestMovementQuery.getSingleResult();
    }

    public Segment findByFromMovement(final Movement movement) throws MovementDaoException {
        try {
            final TypedQuery<Segment> query = em.createNamedQuery("Segment.findByFromMovement", Segment.class);
            query.setParameter("movement", movement);
            final Segment retVal = query.getSingleResult();
            return retVal;
        } catch (final javax.persistence.NoResultException e) {
    ...
    public Boolean hasMovementToOrFromSegment(final Movement movement) throws MovementDaoException {
        try {
            final TypedQuery<Segment> query = em.createNamedQuery("Segment.findByMovement", Segment.class);
            query.setParameter("movement", movement);
            final List<Segment> resultList = query.getResultList();
    ...
    public Segment findByToMovement(final Movement movement) throws MovementDaoException {
        try {
            final long start = System.currentTimeMillis();
            final TypedQuery<Segment> query = em.createNamedQuery("Segment.findByToMovement", Segment.class);
            query.setParameter("movement", movement);
    ...
    @Override
    public Movement getFirstMovement(final String movementConnectValue, final Date date) throws MovementDaoException {
        Movement firstMovememnt;
        try {
            final TypedQuery<Movement> query = em.createNamedQuery("Movement.findFirst", Movement.class);
    ...
    @Override
    public Movement getEntityById(final String id) throws NoEntityFoundException, MovementDaoException {
        try {
            final long start = System.currentTimeMillis();
            em.getEntityManagerFactory().getCache().evictAll();
            final Movement movement = em.find(Movement.class, new Integer(id));
            final long diff = System.currentTimeMillis() - start;
    ...
    public List<Movement> getListAll() throws MovementDaoException {
        try {
            final Query query = em.createNamedQuery(UvmsConstants.MOVEMENT_FIND_ALL);
    ...
    @Override
    public List<Movement> getMovementListPaginated(final Integer page, final Integer listSize, final String sql, final List<SearchValue> searchKeyValues) throws MovementDaoException {
        try {
            final Query query = getMovementQuery(sql, searchKeyValues);
    ...
    @Override
    public List<MinimalMovement> getMinimalMovementListPaginated(final Integer page, final Integer listSize, final String sql, final List<SearchValue> searchKeyValues) throws MovementDaoException {
        try {
            final Query query = getMovementQuery(sql, searchKeyValues);
            query.setFirstResult(listSize * (page - 1));
            query.setMaxResults(listSize);
    ...
    private Query getMovementQuery(final String sql, final List<SearchValue> searchKeyValues) throws ParseException {
    ...
    @Override
    public Long getMovementListSearchCount(final String countSql, final List<SearchValue> searchKeyValues) throws MovementDaoException, ParseException {
        final TypedQuery<Long> query = em.createQuery(countSql, Long.class);
        setTypedQueryMovementParams(searchKeyValues, query);
    ...
    private void setTypedQueryMovementParams(final List<SearchValue> searchKeyValues, final Query query) throws ParseException, IllegalArgumentException {
    ...
    @Override
    public List<Movement> getMovementList(final String sql, final List<SearchValue> searchKeyValues) throws MovementDaoException {
        try {
    ...
    @Override
    public List<Movement> getMovementList(final String sql, final List<SearchValue> searchKeyValues, final int numberOfReports) throws MovementDaoException {
        try {
            ...
            if (searchKeyValues.isEmpty() || searchKeyValues == null) {
                ...
                final TypedQuery<MovementConnect> connectQuery = em.createNamedQuery(UvmsConstants.MOVEMENT_CONNECT_GET_ALL, MovementConnect.class);
                final List<MovementConnect> movementConnects = connectQuery.getResultList();

                for (final MovementConnect movementConnect : movementConnects) {
                    final List<Movement> latestMovementsByConnectId = getLatestMovementsByConnectId(movementConnect.getValue(), numberOfReports);
...
//                query.setFetchSize(numberOfReports);
    ...
    @Override
    public MovementConnect getMovementConnectByConnectId(final String id) throws MovementDaoException {
        try {
            final TypedQuery<MovementConnect> query = em.createNamedQuery(UvmsConstants.MOVEMENT_CONNECT_BY_CONNECT_ID, MovementConnect.class);
            query.setParameter("value", id);
            final MovementConnect singleResult = query.getSingleResult();
    ...
    @Override
    public <T> T merge(final T entity) throws MovementDaoException {
        try {
            em.merge(entity);
            return entity;
        } catch (final Exception e) {
    ...
    @Override
    public <T> T persist(final T entity) throws MovementDaoException {
        try {
            em.persist(entity);
            return entity;
        } catch (final Exception e) {
    ...
    @Override
    public <T> T create(final T entity) throws MovementDaoException {
        try {
            em.persist(entity);
            return entity;
        } catch (final Exception e) {
    ...
    @Override
    public List<Movement> getMovementListByAreaAndTimeInterval(final MovementAreaAndTimeIntervalCriteria criteria) throws MovementDaoException {
        List resultList = new ArrayList();
        final Area areaResult = getAreaByRemoteIdAndCode(criteria.getAreaCode(), null);
        if(areaResult!=null){
            final TypedQuery<Movement> query = em.createNamedQuery(UvmsConstants.MOVEMENT_LIST_BY_AREA_TIME_INTERVAL, Movement.class);
	...
	public List<Movement> getUnprocessedMovements() throws javax.persistence.NoResultException {
        final TypedQuery<Movement> latestMovementQuery = em.createNamedQuery("Movement.findUnprocessed", Movement.class);
	...
	public List<Long> getUnprocessedMovementIds() throws javax.persistence.NoResultException {
        final TypedQuery<Long> latestMovementQuery = em.createNamedQuery("Movement.findUnprocessedId", Long.class);
        latestMovementQuery.setMaxResults(100);
        return latestMovementQuery.getResultList();
    }
    ...
    @Override
    public MovementConnect createMovementConnect(final MovementConnect movementConnect) throws MovementDaoException {
        try {
